...
export default function LearnerJourneyClient() {
    ...
    <div className="text-[11px] text-slate-500">
      ...
      <main className="max-w-6xl mx-auto px-4 lg:px-6 py-6 lg:py-10">
        <h1 className="text-2xl sm:text-3xl font-semibold tracking-tight text-slate-900">
          From German learning to working in Germany
        </h1>
        ...
        <section className="flex-1 grid gap-6 lg:grid-cols-[minmax(0,2fr),minmax(260px,1.3fr)]">
