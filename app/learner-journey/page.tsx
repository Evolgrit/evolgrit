...
export default function LearnerJourneyPage() {
  return (
    <div className="space-y-6 px-4 sm:px-6 lg:px-8 mx-auto max-w-[1200px] py-8">
        ...
        <article className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            <div className="rounded-2xl border border-slate-100 bg-slate-50 p-4">
              ...
              <p className="mt-2 text-lg font-semibold text-slate-900">A2 → B1 path</p>
      ...
      <section className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500">Lightweight blocks, reusable each batch.</p>
          </div>
        </div>
