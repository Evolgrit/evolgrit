...
const moduleData = require("../../../../content/job/pflege/module_02.json");

const skillLessons = [
  {
    id: "pflege_m2_skill_01_vocab",
    title: "Vokabeln",
    subtitle: "Schmerzen & Maßnahmen",
  },
  {
    id: "pflege_m2_skill_02_word_build",
    title: "Satzbau",
    subtitle: "Schmerzfragen bauen",
  },
  {
    id: "pflege_m2_skill_03_dialogue_cloze",
    title: "Mini-Dialog",
    subtitle: "Schmerzen abfragen",
  },
];
...
export default function PflegeModule02Screen() {
  ...
  return (
    <ScreenShell title="Pflege · Modul 2" showBack>
      <ScrollView contentContainerStyle={{ paddingBottom: insets.bottom + 24 }}>
        <YStack padding="$4" gap="$4">
          ...
          <YStack gap="$2">
            ...
            <Text color="$muted">Mini-Lektionen zu Schmerzen</Text>
          </YStack>
          ...
          <YStack gap="$2" marginTop="$2">
            ...
            <Text color="$muted">Schmerzverlauf, Maßnahmen, Alarmzeichen</Text>
          </YStack>

          <YStack gap="$3">
            {(moduleData.liveDialogues ?? []).map((dialogueId: string) => {
              const labelMap: Record<string, string> = {
                job_pflege_live_04_schmerz_verlauf: "Schmerzverlauf",
                job_pflege_live_05_massnahmen_ankuendigen: "Maßnahmen ankündigen",
                job_pflege_live_06_alarmzeichen_hilfe: "Alarmzeichen & Hilfe",
              };
              return (
                <Pressable
                  key={dialogueId}
