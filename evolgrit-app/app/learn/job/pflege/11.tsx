...
const moduleData = require("../../../../content/job/pflege/modules/module_11_exam_preparation.json");

const skillLessons = [
  {
    id: "pflege_m11_skill_01_vocab",
    title: "Vokabeln",
    subtitle: "Pruefung", 
  },
  {
    id: "pflege_m11_skill_02_word_build",
    title: "Satzbau",
    subtitle: "Kurz antworten",
  },
  {
    id: "pflege_m11_skill_03_dialogue_cloze",
    title: "Mini-Dialog",
    subtitle: "Pruefungsfrage ueben",
  },
];

export default function PflegeModule11Screen() {
  ...
  return (
    <ScreenShell title="Pflege · Modul 11" showBack>
      <ScrollView contentContainerStyle={{ paddingBottom: insets.bottom + 24 }}>
        <YStack padding="$4" gap="$4">
          ...
          <YStack gap="$2">
            ...
            <Text color="$muted">Mini-Lektionen zur Pruefung</Text>
          </YStack>
          ...
          <YStack gap="$2" marginTop="$2">
            ...
            <Text color="$muted">Pruefungsfrage</Text>
          </YStack>

          <YStack gap="$3">
            {(moduleData.liveDialogues ?? []).map((dialogueId: string) => {
              const labelMap: Record<string, string> = {
                job_pflege_live_11_pruefung: "Pruefungsfrage ueben",
              };
              return (
                <Pressable
                  key={dialogueId}
