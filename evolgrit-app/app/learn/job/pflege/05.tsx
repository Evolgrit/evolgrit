...
const moduleData = require("../../../../content/job/pflege/module_05.json");

const skillLessons = [
  {
    id: "pflege_m5_skill_01_vocab",
    title: "Vokabeln",
    subtitle: "Vitalwerte",
  },
  {
    id: "pflege_m5_skill_02_word_build",
    title: "Satzbau",
    subtitle: "Vitalwerte sagen",
  },
  {
    id: "pflege_m5_skill_03_dialogue_cloze",
    title: "Mini-Dialog",
    subtitle: "Vitalwerte abfragen",
  },
];

export default function PflegeModule05Screen() {
  ...
  return (
    <ScreenShell title="Pflege · Modul 5" showBack>
      <ScrollView contentContainerStyle={{ paddingBottom: insets.bottom + 24 }}>
        <YStack padding="$4" gap="$4">
          ...
          <YStack gap="$2">
            ...
            <Text color="$muted">Mini-Lektionen zu Vitalwerten</Text>
          </YStack>
          ...
          <YStack gap="$2" marginTop="$2">
            ...
            <Text color="$muted">Blutdruck, Temperatur, Auffälliges</Text>
          </YStack>
