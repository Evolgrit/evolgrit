...
const moduleData = require("../../../../content/job/pflege/modules/module_08_observation_reasoning.json");

const skillLessons = [
  {
    id: "pflege_m8_skill_01_vocab",
    title: "Vokabeln",
    subtitle: "Beobachtung", 
  },
  {
    id: "pflege_m8_skill_02_word_build",
    title: "Satzbau",
    subtitle: "Beobachten und begruenden",
  },
  {
    id: "pflege_m8_skill_03_dialogue_cloze",
    title: "Mini-Dialog",
    subtitle: "Beobachtung berichten",
  },
];

export default function PflegeModule08Screen() {
  ...
  return (
    <ScreenShell title="Pflege · Modul 8" showBack>
      <ScrollView contentContainerStyle={{ paddingBottom: insets.bottom + 24 }}>
        <YStack padding="$4" gap="$4">
          ...
          <YStack gap="$2">
            ...
            <Text color="$muted">Mini-Lektionen zur Beobachtung</Text>
          </YStack>
          ...
          <YStack gap="$2" marginTop="$2">
            ...
            <Text color="$muted">Beobachtung berichten</Text>
          </YStack>

          <YStack gap="$3">
            {(moduleData.liveDialogues ?? []).map((dialogueId: string) => {
              const labelMap: Record<string, string> = {
                job_pflege_live_08_beobachtung: "Beobachtung berichten",
              };
              return (
                <Pressable
                  key={dialogueId}
