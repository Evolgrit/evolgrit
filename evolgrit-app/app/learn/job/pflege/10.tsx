...
const moduleData = require("../../../../content/job/pflege/modules/module_10_rights_boundaries.json");

const skillLessons = [
  {
    id: "pflege_m10_skill_01_vocab",
    title: "Vokabeln",
    subtitle: "Rechte & Grenzen", 
  },
  {
    id: "pflege_m10_skill_02_word_build",
    title: "Satzbau",
    subtitle: "Grenzen formulieren",
  },
  {
    id: "pflege_m10_skill_03_dialogue_cloze",
    title: "Mini-Dialog",
    subtitle: "Ruecksprache und Grenzen",
  },
];

export default function PflegeModule10Screen() {
  ...
  return (
    <ScreenShell title="Pflege · Modul 10" showBack>
      <ScrollView contentContainerStyle={{ paddingBottom: insets.bottom + 24 }}>
        <YStack padding="$4" gap="$4">
          ...
          <YStack gap="$2">
            ...
            <Text color="$muted">Mini-Lektionen zu Rechten</Text>
          </YStack>
          ...
          <YStack gap="$2" marginTop="$2">
            ...
            <Text color="$muted">Grenzen setzen</Text>
          </YStack>

          <YStack gap="$3">
            {(moduleData.liveDialogues ?? []).map((dialogueId: string) => {
              const labelMap: Record<string, string> = {
                job_pflege_live_10_grenzen: "Grenzen setzen",
              };
              return (
                <Pressable
                  key={dialogueId}
