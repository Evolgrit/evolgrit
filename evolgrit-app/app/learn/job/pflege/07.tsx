...
const moduleData = require("../../../../content/job/pflege/modules/module_07_responsibility.json");

const skillLessons = [
  {
    id: "pflege_m7_skill_01_vocab",
    title: "Vokabeln",
    subtitle: "Meldewege", 
  },
  {
    id: "pflege_m7_skill_02_word_build",
    title: "Satzbau",
    subtitle: "Meldung formulieren",
  },
  {
    id: "pflege_m7_skill_03_dialogue_cloze",
    title: "Mini-Dialog",
    subtitle: "Melden und dokumentieren",
  },
];

export default function PflegeModule07Screen() {
  ...
  return (
    <ScreenShell title="Pflege · Modul 7" showBack>
      <ScrollView contentContainerStyle={{ paddingBottom: insets.bottom + 24 }}>
        <YStack padding="$4" gap="$4">
          ...
          <YStack gap="$2">
            ...
            <Text color="$muted">Mini-Lektionen zu Meldewegen</Text>
          </YStack>
          ...
          <YStack gap="$2" marginTop="$2">
            ...
            <Text color="$muted">Melden</Text>
          </YStack>

          <YStack gap="$3">
            {(moduleData.liveDialogues ?? []).map((dialogueId: string) => {
              const labelMap: Record<string, string> = {
                job_pflege_live_07_melden: "Melden (kurz & klar)",
              };
              return (
                <Pressable
                  key={dialogueId}
