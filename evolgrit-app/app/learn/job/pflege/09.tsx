...
const moduleData = require("../../../../content/job/pflege/modules/module_09_difficult_communication.json");

const skillLessons = [
  {
    id: "pflege_m9_skill_01_vocab",
    title: "Vokabeln",
    subtitle: "Schwierige Gespraeche", 
  },
  {
    id: "pflege_m9_skill_02_word_build",
    title: "Satzbau",
    subtitle: "Ruhig bleiben",
  },
  {
    id: "pflege_m9_skill_03_dialogue_cloze",
    title: "Mini-Dialog",
    subtitle: "Professionell reagieren",
  },
];

export default function PflegeModule09Screen() {
  ...
  return (
    <ScreenShell title="Pflege · Modul 9" showBack>
      <ScrollView contentContainerStyle={{ paddingBottom: insets.bottom + 24 }}>
        <YStack padding="$4" gap="$4">
          ...
          <YStack gap="$2">
            ...
            <Text color="$muted">Mini-Lektionen zu Gespraechen</Text>
          </YStack>
          ...
          <YStack gap="$2" marginTop="$2">
            ...
            <Text color="$muted">Angehoerige beruhigen</Text>
          </YStack>

          <YStack gap="$3">
            {(moduleData.liveDialogues ?? []).map((dialogueId: string) => {
              const labelMap: Record<string, string> = {
                job_pflege_live_09_angehoerige: "Angehoerige beruhigen",
              };
              return (
                <Pressable
                  key={dialogueId}
