...
const moduleData = require("../../../../content/job/pflege/module_03.json");

const skillLessons = [
  {
    id: "pflege_m3_skill_01_vocab",
    title: "Vokabeln",
    subtitle: "Medikamente & Zeiten",
  },
  {
    id: "pflege_m3_skill_02_word_build",
    title: "Satzbau",
    subtitle: "Medikamente erklären",
  },
  {
    id: "pflege_m3_skill_03_dialogue_cloze",
    title: "Mini-Dialog",
    subtitle: "Medikamente erklären",
  },
];
...
export default function PflegeModule03Screen() {
  ...
  return (
    <ScreenShell title="Pflege · Modul 3" showBack>
      <ScrollView contentContainerStyle={{ paddingBottom: insets.bottom + 24 }}>
        <YStack padding="$4" gap="$4">
          ...
          <YStack gap="$2">
            ...
            <Text color="$muted">Mini-Lektionen zu Medikamenten</Text>
          </YStack>
          ...
          <YStack gap="$2" marginTop="$2">
            ...
            <Text color="$muted">Medikamente ankündigen, Zeiten, Rückfragen</Text>
          </YStack>

          <YStack gap="$3">
            {(moduleData.liveDialogues ?? []).map((dialogueId: string) => {
              const labelMap: Record<string, string> = {
                job_pflege_live_07_medikament_ankuendigen: "Medikament ankündigen",
                job_pflege_live_08_zeitplan_erklaeren: "Zeitplan erklären",
                job_pflege_live_09_rueckfragen_allergie: "Rückfragen & Allergie",
              };
              return (
                <Pressable
                  key={dialogueId}
